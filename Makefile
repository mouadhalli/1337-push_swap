...
SRC = push_swap.c sorting_src/buff_utils.c error_utils.c stack_constructor.c stack_destructor.c \
		...
		ps_utils/ps_atoi.c ps_utils/ps_strlen.c ps_utils/ps_putstr.c ps_utils/ps_split.c
...
$(NAME):
	# @make -C libft
	@gcc $(MOMALA7AT) $(FLAGS) $(SRC) -g -o $(NAME)

$(BONUS_NAME):
	@make -C libft
	@gcc $(MOMALA7AT) $(FLAGS) $(BONUS_SRC) -g -o $(BONUS_NAME)
